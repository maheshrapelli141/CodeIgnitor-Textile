            ...
            foreach ($products as $product):
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="<?php echo base_url($product['third_image']); ?>" height="64px" width="64px">
                        <img src="<?php echo base_url($product['fourth_image']); ?>" height="64px" width="64px">
                        <img src="<?php echo base_url($product['fifth_image']); ?>" height="64px" width="64px">
                    </td>
